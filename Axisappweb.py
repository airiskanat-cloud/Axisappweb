...
def main():
    ...
    # st.info(f"Источник данных загружен.")  # нейтральное сообщение
    ...
    if calc_button:
        ...
        with tab1:
            ...
            if gabarit_rows:
                ...
                st.dataframe(gab_disp, width="stretch")
        ...
        with tab2:
            ...
            if material_rows:
                ...
                st.dataframe(mat_disp, width="stretch")
        ...
        with tab3:
            ...
            if final_rows:
                ...
                st.dataframe(fin_disp, width="stretch")
